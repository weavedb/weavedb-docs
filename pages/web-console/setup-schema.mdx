...
Using the [web console](https://console.weavedb.dev/), navigate to the `Schema` section in the side menu, select `people` from the collections list, then click `+` in the top right corner.
