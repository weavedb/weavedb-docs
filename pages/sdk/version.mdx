...
- [addAddressLink with PolygonID](/sdk/authentication#polygonid-didvczkp)
...
- [PolygonID zkp verification](/query-api/write-queries#zkp)
...
- deterministic ID generation with input values for [add queries](/query-api/write-queries#add)
...
- [conditional statements in access control rules](/sdk/rules#conditional-statements)
- [renaming method in access control rules](/sdk/rules#renaming-method)
...
- [get query in access control](/sdk/rules#get-other-data)
...
- [tick](/sdk/crons/#tick)
- [conditional statements](/sdk/crons#conditional-statements) for FPJSON
...
-  [dot notation](/sdk/queries#where)
...
-  [internal writes](/sdk/relayers#internal-writes)
...
-  [bundle query](/sdk/queries#bundle)
...
- [`=` deprecated](/sdk/queries#get--cget)
...
- [getHash()](/sdk/queries#gethash) for consistency check
...
- copy new `version` to state on [migration](/sdk/evolve#upgrade--evolve-db-contract) (internal change)
...
- [batch execution of admin methods](/sdk/queries#batch)
- `contract` field to [access control rules](/sdk/rules#preset-variables)
...
- [setSecure()](/runlocally/repl#deploy-db-in-secure-mode)
- [migrate()](/sdk/evolve#upgrade--evolve-db-contract)
- [getEvolve()](/sdk/evolve#get-evolve-stats)
...
- [auto-index doc ids](/sdk/indexes#__id__)
- [listRelayerJobs()](/sdk/relayers#list-relayer-jobs)
...
- [better owner validation for crons](/sdk/crons)
...
- [set/update subcollections](/sdk/queries#set)
...
- [listCollections()](/sdk/queries#listcollections) : list sub collections too
...
- [listCollections()](/sdk/queries#listcollections)
- [getInfo()](/sdk/queries#getInfo)
...
- [secp256k1-2 algorithm for Intmax is now settable](/sdk/auth#intmaxwallet-intmax)
...
- [overwrite temporary address](/sdk/auth)
...
- [multisig relayers](/sdk/relayers#multisig-relayer)
- [Lit Protocol Integration](/sdk/relayers#verifiable-oracles-with-lit-protocol)
...
- [relayers](/sdk/relayers) : `getRelayerJob`, `setRelayerJob`, `removeRelayerJob`
- `sign` and `relay` added to [the SDKs](/sdk/setup)
