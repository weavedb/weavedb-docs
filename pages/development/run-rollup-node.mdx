...
To show a list of accounts, open your terminal, navigate to your project's root directory, and execute the following command:
...
Open a new terminal and clone the WeaveDB repository into a new directory outside of your project's root directory.
