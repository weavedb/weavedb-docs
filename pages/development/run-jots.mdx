...
From the root directory of your local WeaveDB repo, run the following commands in the terminal to navigate to the `db` directory of the Jots project and generate keys for the `owner` and the `relayer`.
...
Run the following commands in the terminal to deploy and set up a database instance. Make sure your terminal is in the `db` directory of the Jots project.
