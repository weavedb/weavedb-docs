...
- To effectively follow this tutorial, you should be familiar with the development workflow as outlined in these guides: [Run Local Test](/development/run-local-test) and [Runt Rollup Node](/development/run-rollup-node).
