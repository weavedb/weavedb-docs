...
- `startAt` : Begin fetching documents starting at a specific value.
- `startAfter` : Fetch documents after a specific value.
- `endAt` : Fetch documents up to a specific value.
- `endAfter` : Fetch documents until just after a specific value.
...
#### Skip with specific start point
...
Manages the retrieval of documents in pages, facilitating the handling of large datasets.
