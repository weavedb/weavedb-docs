...
Also, it is expected that `collection_name` refers to the string variable that contains the name of your collection, and `doc_id` refers to the string variable that contains the unique identifier of a document from the collection.
</Callout>
