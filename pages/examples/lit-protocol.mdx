...
4. [Set up Local gRPC Node](/examples/relayer-nft#set-up-local-grpc-node)
...
If you followed [the previous tutorial](/examples/relayer-nft), you should have a frontend dapp set up already.
