...
We assume you have followed [the previous tutorial](/examples/relayer-nft). If not, please do the following 3 steps and come back here.

1. [Clone the Repo](/examples/relayer-nft)
2. [Deploy NFT](/examples/relayer-nft#deploy-nft)
3. [Deploy WeaveDB Contract](/examples/relayer-nft#deploy-weavedb-contracts)
4. [Set up Local gRPC Node](/examples/lit-protocol#set-up-local-grpc-node)
...
If you followed [the previous tutorial](/examples/relayer-nft), you should have a frontend dapp set up alreasy.

If not, you should follow the first two sections now.

1. [Create NextJS Project](/examples/relayer-nft#create-nextjs-project)
2. [Install Dependencies](/examples/relayer-nft#install-dependencies)
