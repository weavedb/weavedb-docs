...
yarn deploy
```
Or you could follow [this tutorial](/examples/todos-console) and use the [Web Console](https://console.weavedb.dev).
...
- [WeaveDB Client](/advanced/client) - to connect with the gRPC node from browsers
- [WeaveDB Node Client](/advanced/client) - to connect with the gRPC node from the serverless api
