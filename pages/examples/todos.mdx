...
<Tabs items={['yarn', 'npm']}>
  ...
  <Tab>
  ```bash copy
  npm install ramda localforage weavedb-sdk ethers@5.7.2 @chakra-ui/react @emotion/react@^11 @emotion/styled@^11 framer-motion@^6
  ```
  </Tab>
</Tabs>
...
Change the string value "WEAVEDB_CONTRACT_TX_ID" to the contractTxId you was given when you [Deploy a Database](/get-started/deploy-database)

</Callout>

```js copy  filename="/pages/index.js"
...
You can also access the entire dapp code at our [Github repo](https://github.com/weavedb/weavedb-docs/tree/main/examples/todos).
