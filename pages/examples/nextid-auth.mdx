...
This demo is a variant of the [custom authentication](/examples/custom-auth) flow to let WeaveDB dapps use web2 identities such as Twitter and Github.
...
We are in the process of making the Next.ID flow built-in with the WeaveDB SDK and the core contracts. This demo is rather to show you what is possible with the [custom authentication](/examples/custom-auth) flow.
</Callout>
