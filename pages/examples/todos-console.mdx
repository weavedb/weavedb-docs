...
Go to the [cloud Web Console](https://console.weavedb.dev) or you can also use your [local Web Console](/runlocally/web-console).
...
[Access control rules](/permissions/rules) are defined by [JSONLogic](https://jsonlogic.com/).
