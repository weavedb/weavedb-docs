...
Within your folder, create a file named `get-node-info.js` if it does not already exist.
...
const db = new WeaveDB({ rpc: "localhost:8080", contractTxId: "your_db_name" })
...
Within your folder, create a file named `add.js` if it does not already exist.
...
Within your folder, create a file named `deploy.js` if it does not already exist.
...
Within your folder, create a file named `update.js` if it does not already exist.
...
Within your folder, create a file named `remove.js` if it does not already exist.
...
Within your folder, create a file named `query.js` if it does not already exist.
